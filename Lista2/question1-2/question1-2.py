...
data.rename(columns={2:'Col3', 4:'Col5'}, inplace=True)
...
for d in dList:
	...
	pylab.scatter(data.Col3.get_values(), data.Col5.get_values())
	pylab.plot(X, Z, c='red')

	pylab.title('Question 1.2 - Polynomial Regression - d = '+str(d))
	pylab.xlabel('Hora')
	pylab.ylabel('Vazao')
